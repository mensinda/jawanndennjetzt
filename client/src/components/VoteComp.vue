<template>
  <div class="rounded-1 vote-container" :class="containerCls">
    <div class="ballot-box" :class="btnBoxCls" @click="handleClick(false)" @contextmenu.prevent="handleClick(true)">
      <svg height="18" width="18" viewBox="0 0 512 512" fill="currentColor" v-if="realVote?.status == 'M'">
      ...
      <svg fill="currentColor" viewBox="0 0 352.62 352.62" width="18" height="18" v-if="realVote?.status == 'Y'">
        <g>
          <path
